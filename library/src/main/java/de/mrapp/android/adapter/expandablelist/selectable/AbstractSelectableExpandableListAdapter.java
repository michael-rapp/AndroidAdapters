...
public abstract class AbstractSelectableExpandableListAdapter<GroupType, ChildType> extends
     ...
     */
    private transient ListenerList<ExpandableListSelectionListener<GroupType, ChildType>>
            selectionListeners;
    ...
    /**
     * Returns a list, which contains the listeners, which should be notified, when the selection of
     * an item of the adapter has been changed.
     *
     * @return A list, which contains the listeners, which should be notified when the selection of
     ...
     */
    protected final ListenerList<ExpandableListSelectionListener<GroupType, ChildType>> getSelectionListeners() {
        return selectionListeners;
    }

    /**
     * Sets the list, which contains the listeners, which should be notified, when the selection of
     * an item of the adapter has been changed.
     *
