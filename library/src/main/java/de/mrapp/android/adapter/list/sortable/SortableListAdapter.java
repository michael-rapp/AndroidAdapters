...
public interface SortableListAdapter<DataType> {
	 ...
	 *         sorted yet or if the adapter's underlying data has been changed
	 *         since it has been sorted the last time. If not null, the order
	 *         may either be <code>ASCENDING</code> or <code>DESCENDING</code>
	 */
	Order getOrder();
