...
public interface ExpandableListEnableStateListener<GroupType, ChildType> {
	 ...
	 *            be null
	 * @param group
	 *            The group item, the child, which has been enabled, belongs to,
	 *            as an instance of the generic type GroupType. The group item
	 *            may not be null
	 * @param groupIndex
	 ...
	 *            be null
	 * @param group
	 *            The group item, the child, which has been disabled, belongs
