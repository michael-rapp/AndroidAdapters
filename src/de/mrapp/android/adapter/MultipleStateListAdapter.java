 ...
 * of arbitrary items with multiple states, must implement. Such an adapter is
 ...
 * @since 1.0.0
 */
public interface MultipleStateListAdapter<DataType> extends
		ListAdapter<DataType> {

	@Override
	MultipleStateListAdapter<DataType> clone()
