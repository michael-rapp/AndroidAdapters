...
/**
 * An iterator, which allows to iterate the data of groups, which can be
 * iterated by using an other iterator.
 * 
 * @param <GroupType>
...
public class GroupIterator<GroupType, ChildType> implements Iterator<GroupType> {
	...
	/**
	 * Creates a new iterator, which allows to iterate the data of groups, which
	 * can be iterated by using an other iterator.
	 * 
	 * @param iterator
	 *            The iterator, which allows to iterate the groups, as an
