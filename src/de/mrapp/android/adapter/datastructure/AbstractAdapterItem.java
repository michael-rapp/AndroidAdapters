...
/**
 * An abstract base class for all data structure, which holds the data of an
 * item of an adapter.
 * 
 * @param <DataType>
...
public abstract class AbstractAdapterItem<DataType>
		implements DataStructure, Parcelable, Comparable<AbstractAdapterItem<DataType>>, Filterable {
