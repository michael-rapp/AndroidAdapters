...
/**
 * An utility class, which provides the sample data, which is used by the example app.
 *
 * @author Michael Rapp
 */
public final class SampleData {
    ...
    /**
     * Creates a new utility class, which provides the sample data, which is used by the example
     * app.
     */
    private SampleData() {
